...
if (value == "") {
    ...
    clearTasks() {
        if (this.#tasks.length > 0) {
            ...
            alert("Ты сначала напиши что-нибудь")
        )
    }
...
document.querySelector('.text-field__button').addEventListener('click', function() {
    var e = new KeyboardEvent('keydown', {keyCode: 13});
    document.querySelector('.text-field__input').dispatchEvent(e);
});
